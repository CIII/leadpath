...
public class WhitepagesAcceptFilterTest {
	...
	public void testAcceptable() {
		...
		WhitepagesAcceptFilter acceptFilter = new WhitepagesAcceptFilter(TEST_PARAMETER_NAME);
		for(String value : filterValues) {
			acceptFilter.addValue(value);
		}
		
		if(shouldPass == null) {
			try {
				acceptFilter.pass(null,  null, lead, null);
				fail("Did not throw exception");
			} catch (Exception e) {
				
			}
		} else {
			boolean passed = acceptFilter.pass(null, null, lead, null);
	...
	public static Collection<Object[]> values() {
		...
		return Arrays.asList( new Object[][] {
			{ testAttributes1, testFilterValues1, Boolean.TRUE },
			{ testAttributes2, testFilterValues2, Boolean.FALSE },
			{ testAttributes3, testFilterValues3, Boolean.FALSE},
