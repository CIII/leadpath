...
public class AutoRequest  implements java.io.Serializable {
    private com.arb.ws.clients.reply.AutomotiveLead automotiveLead;

    private com.arb.ws.clients.reply.AutoRequestUser user;
    ...
    public AutoRequest(
           ...
           com.arb.ws.clients.reply.AutoRequestUser user,
    ...
    /**
     * Gets the automotiveLead value for this AutoRequest.
     * 
    ...
    /**
     * Sets the automotiveLead value for this AutoRequest.
     * 
    ...
    /**
     * Gets the user value for this AutoRequest.
     * 
     * @return user
     */
    public com.arb.ws.clients.reply.AutoRequestUser getUser() {
        return user;
    }


    /**
     * Sets the user value for this AutoRequest.
     * 
     * @param user
     */
    public void setUser(com.arb.ws.clients.reply.AutoRequestUser user) {
        this.user = user;
    }


    /**
     * Gets the reservationToken value for this AutoRequest.
     * 
    ...
    /**
     * Sets the reservationToken value for this AutoRequest.
     * 
    ...
    /**
     * Gets the ignoreExpiration value for this AutoRequest.
     * 
    ...
    /**
     * Sets the ignoreExpiration value for this AutoRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AutoRequest)) return false;
        AutoRequest other = (AutoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AutoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Reply.LeadMarketPlace.Services.Post.ServiceContracts/2007/10/PostMessageTypes", "AutoRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://Reply.LeadMarketPlace.Services.Post.ServiceContracts/2007/10/PostMessageTypes", ">AutoRequest>User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
